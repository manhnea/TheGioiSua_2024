...
public class EmailSend {
  ...
  public void sendAccountPasswordEmail(String email, String username, String password) {
    ...
    String message = "<!DOCTYPE html>\n"
            ...
            + "        p { font-size: 16px; color: #939393; font-family: 'Nunito Sans', sans-serif; }\n"
            ...
            + "</head>\n"
            + "<body>\n"
            + "    <div class=\"header\">Chúc mừng, tài khoản của bạn đã được tạo thành công!</div>\n"
            + "    <p>Xin chào <strong>" + username + "</strong>,</p>\n"
            + "    <p>Chúng tôi rất vui mừng thông báo rằng tài khoản của bạn đã được tạo thành công trên hệ thống của chúng tôi. Bạn có thể bắt đầu khám phá các dịch vụ ngay bây giờ.</p>\n"
            + "    <p><strong>Tên tài khoản:</strong> " + username + "</p>\n"
            + "    <p><strong>Mật khẩu:</strong> " + password + "</p>\n"
            + "    <p>Vui lòng giữ thông tin này an toàn và không chia sẻ với bất kỳ ai. Để bảo mật tài khoản của bạn, chúng tôi khuyến khích bạn thay đổi mật khẩu ngay sau khi đăng nhập lần đầu tiên.</p>\n"
            + "    <p>Để đăng nhập vào hệ thống, vui lòng nhấn vào nút dưới đây:</p>\n"
            + "    <a href=\"" + loginUrl + "\" class=\"cta-button\">Đăng nhập vào tài khoản</a>\n"
            + "    <p class=\"footer\">Nếu bạn có bất kỳ câu hỏi nào hoặc cần sự trợ giúp, đừng ngần ngại liên hệ với chúng tôi. Chúng tôi luôn sẵn sàng hỗ trợ bạn.</p>\n"
            + "    <p class=\"theme-color\">Cảm ơn bạn đã lựa chọn dịch vụ của chúng tôi!</p>\n"
            + "</body>\n"
            + "</html>";
